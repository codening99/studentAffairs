...
public interface TeacherService extends UserService {
     ...
     */
    String addAccount(HttpSession session, Object object);
    String modifyAccount(HttpSession session, Object object);
    String delAccount(HttpSession session, Object object);
    String selectAccount(HttpSession session, Class<?> c);
